				...
				<div class="slider-container">
					<div class="intro-text">
						<form method="post">
							...
							<label for="lname">Digite o nome do qual o número será atualizado:</label>
							<input type="text" name="name" style="color:black;">
							<label for="lname">Digite o novo número:</label>
							<input type="text" name="num" style="color:black;">

							<input type="submit" value="<?php echo "Atualizar"?>" style="color:white; ">
						</form>    
					</div>
				</div>
			</div>
